...
import { useInterrupt } from "../streaming-avatar/useInterrupt";
...
export function VideoStreamControls({ onStart, onStop }: VideoControlsProps) {
        ...
        {sessionState === StreamingAvatarSessionState.INACTIVE ? (
          ...
          <div className="w-full flex flex-col gap-1 justify-center items-center">
            <button
              ...
              className="w-14 h-14 bg-green-500/90 rounded-full flex items-center justify-center text-white hover:bg-green-500 hover:scale-105 transition-all duration-200 shadow-lg"
            >
              {isConnecting ? (
